      ...
      it("as admin should succeed", async function () {
        await expect(
          this.violetID
            ...
            .grantStatus(this.signers.user.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00"),
        )
          .to.emit(this.violetID, "GrantedStatus")
          .withArgs(this.signers.user.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID);
    ...
    context("Contract target", async function () {
      it("as admin should succeed", async function () {
        await expect(
          this.violetID
            .connect(this.signers.admin)
            .grantStatus(this.mockContract.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00"),
        )
          .to.emit(this.violetID, "GrantedStatus")
          .withArgs(this.mockContract.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID);
    ...
    context("EOA target", async function () {
      ...
      it("as admin should succeed", async function () {
        await expect(
          this.violetID
            .connect(this.signers.admin)
            .revokeStatus(this.signers.user.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00"),
        ).to.not.be.reverted;
      ...
      it("as admin should emit event", async function () {
        await expect(
          ...
          .withArgs(this.signers.user.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00");
    ...
    context("Contract target", async function () {
      ...
      it("as admin should succeed", async function () {
        await expect(
          this.violetID
            .connect(this.signers.admin)
            .revokeStatus(this.mockContract.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00"),
        ).to.not.be.reverted;
      ...
      it("as admin should emit event", async function () {
        await expect(
          ...
          .to.emit(this.violetID, "RevokedStatus")
          .withArgs(this.mockContract.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID, "0x00");
        ...
        await expect(
          this.violetID
            ...
            .safeTransferFrom(
              ...
              this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID,
              1,
              "0x00",
            ),
    ...
    context("EOA holder", async function () {
      it("user should have status", async function () {
        ...
        expect(
          await this.violetID
            .connect(this.signers.user)
            .hasStatus(this.signers.user.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID),
        ).to.be.true;
      });
    ...
    context("Contract holder", async function () {
      it("contract should have status", async function () {
        ...
        expect(
          await this.violetID
            .connect(this.signers.user)
            .hasStatus(this.mockContract.address, this.MAUVE_VERIFIED_ENTITY_STATUS_TOKENID),
        ).to.be.true;
      });
